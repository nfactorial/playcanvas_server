...
function getCognitoId(facebookToken) {
    var params = {
    ...
    credentials.get(function(err) {
        if (err) {
            ...
            const tempCredentials = credentials.data.Credentials;
            console.log('Cognito identity id: ' + tempCredentials.identityId);
        }
    });
}
